...
function OnAdd() {
    ...
    inputValue.split(',').forEach(function(value){
        ...
        i.className = 'remove';
        document.querySelector('.resource-container .resource').appendChild(span);
        document.querySelector('.resource-container .resource').appendChild(i);
    });
...
var ResourceTemplate = '<span class="resource-text">${template}</span><i class="remove"></i>';
